          ...
          <div class="{{ $posts_columns }}">
              <a href="{{ $posts_data_source === 'input' ? $post->permalink : get_permalink($post->ID) }}" class="{{ $classes }}" data-equal-item>
                  ...
                  <div class="box-content">
                      ...
                      <a class="link-item" href="{{ get_permalink($post->ID) . '#modal-edit-post' }}">EDIT POST</a>

                      <a class="link-item" href="{{ get_permalink($post->ID) . '#comments' }}">COMMENTS <span>{{count(get_comments(array('post_id' => $post->ID)))}}</span></a>
